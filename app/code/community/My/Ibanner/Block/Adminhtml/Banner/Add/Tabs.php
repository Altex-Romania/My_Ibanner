 ...
 */
class My_Ibanner_Block_Adminhtml_Banner_Add_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('ibanner/adminhtml_banner_add_tab_form')->toHtml(),
        ))->addTab('image_section', array(
            'label'     => Mage::helper('ibanner')->__('Banner Images'),
            'title'     => Mage::helper('ibanner')->__('Banner Images'),
            'content'   => $this->getLayout()->createBlock('ibanner/adminhtml_banner_add_tab_image')->toHtml(),
        ))->addTab('page_section', array(
            'label'     => Mage::helper('ibanner')->__('Display on Pages'),
            'title'     => Mage::helper('ibanner')->__('Display on Pages'),
            'content'   => $this->getLayout()->createBlock('ibanner/adminhtml_banner_add_tab_page')->toHtml(),
            ...
            'content'   => $this->getLayout()->createBlock('ibanner/adminhtml_banner_add_tab_category')->toHtml(),
        ));
